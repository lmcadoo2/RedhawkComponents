...
class ResourceTests(ossie.utils.testing.ScaComponentTestCase):
    """Test for all resource implementations in ReedSolomonEncoderDecoder"""
...
if __name__ == "__main__":
    ossie.utils.testing.main("../ReedSolomonEncoderDecoder.spd.xml") # By default tests all implementations
